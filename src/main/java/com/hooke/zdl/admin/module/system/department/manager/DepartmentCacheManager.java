package com.hooke.zdl.admin.module.system.department.manager;

import com.google.common.collect.Lists;
import com.google.common.collect.Maps;
import com.hooke.zdl.admin.common.util.SmartBeanUtil;
import com.hooke.zdl.admin.constant.AdminCacheConst;
...
public class DepartmentCacheManager {
    ...
    public Map<Long, DepartmentVO> getDepartmentMap() {
        ...
        return departmentVOS.stream().collect(Collectors.toMap(DepartmentVO::getDepartmentId, Function.identity()));
    }
