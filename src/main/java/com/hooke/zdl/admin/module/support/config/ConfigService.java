...
public class ConfigService {
    ...
    private void loadConfigCache() {
        CONFIG_CACHE.clear();
        List<ConfigEntity> entityList = configDao.selectAll();
    ...
    private void refreshConfigCache(Long configId) {
        // 重新查询 加入缓存
        ConfigEntity configEntity = configDao.selectOneById(configId);
    ...
    public ResponseDTO<String> updateConfig(ConfigUpdateForm updateDTO) {
        ...
        ConfigEntity entity = configDao.selectOneById(configId);
        if (null == entity) {
