package com.hooke.zdl.admin.module.system.department.service;
...
import com.hooke.zdl.admin.module.system.department.manager.DepartmentCacheManager;
...
public class DepartmentService {
    ...
    public ResponseDTO<String> updateDepartment(DepartmentUpdateForm updateDTO) {
        ...
        DepartmentEntity entity = departmentDao.selectOneById(updateDTO.getDepartmentId());
        if (entity == null) {
