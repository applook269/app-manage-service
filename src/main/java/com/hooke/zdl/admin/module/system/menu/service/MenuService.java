package com.hooke.zdl.admin.module.system.menu.service;
...
import com.hooke.zdl.admin.module.system.menu.constant.MenuTypeEnum;
import com.hooke.zdl.admin.module.system.menu.dao.MenuDao;
...
import com.hooke.zdl.admin.module.system.menu.domain.form.MenuBaseForm;
...
public class MenuService {
    ...
    public synchronized ResponseDTO<String> updateMenu(MenuUpdateForm menuUpdateForm) {
        //校验菜单是否存在
        MenuEntity selectMenu = menuDao.selectOneById(menuUpdateForm.getMenuId());
        if (selectMenu == null) {
    ...
    public ResponseDTO<MenuVO> getMenuDetail(Long menuId) {
        //校验菜单是否存在
        MenuEntity selectMenu = menuDao.selectOneById(menuId);
        if (selectMenu == null) {
